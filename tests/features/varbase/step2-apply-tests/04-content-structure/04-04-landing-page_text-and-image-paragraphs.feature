...
@local @development @staging @production
  ...
  Scenario: Check if a user with a permission to manage "Landing page" content type create a new Landing page that will look like this page
