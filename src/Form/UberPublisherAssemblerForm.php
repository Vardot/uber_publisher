  ...
  public function buildForm(array $form, FormStateInterface $form_state, array &$install_state = NULL) {
    ...
    if (count($extraFeatures)) {
      ...
      foreach ($extraFeatures as $extra_feature_key => $extra_feature_info) {
        ...
        if (isset($extra_feature_info['target_lang'])) {
          // Check if target lang not equal current lang.
          if ($extra_feature_info['target_lang'] != \Drupal::languageManager()->getCurrentLanguage()->getId()) {
        ...
        $extra_feature_info['config_form'] == TRUE) {
          ...
          if (isset($extra_feature_info['formbit'])) {
            $formbit_file_name = drupal_get_path('profile', 'uber_publisher') . '/' . $extra_feature_info['formbit'];
