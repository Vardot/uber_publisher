...
```
composer create-project vardot/uber_publisher-project:~10 PROJECT_DIR_NAME --stability dev --no-interaction
```

To install the dev version of Uber Publisher 10.0.x run this command:
```
composer create-project vardot/uber_publisher-project:10.0.x-dev PROJECT_DIR_NAME --stability dev --no-interaction
```
...
## [CHANGELOG for Uber Publisher](https://github.com/Vardot/uber_publisher/blob/10.0.x/CHANGELOG.md)

## [TO DO](https://github.com/Vardot/uber_publisher/blob/10.0.x/TODO.md)

## [General instructions on how to update Uber Publisher](https://github.com/Vardot/uber_publisher/blob/10.0.x/UPDATE.md)
